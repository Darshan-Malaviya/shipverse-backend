...
if Environment:
    ...
    SHOPIFY_CLIENT_ID = os.environ.get('shopify_client_id_debug')
    SHOPIFY_CLIENT_SECRET = os.environ.get('shopify_client_secret_debug')
    SHOPIFY_REDIRECT_URL = os.environ.get('shopify_redirect_url_debug')
